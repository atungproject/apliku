                ...
                <div class="x_content">
                    ...
                    <div data-parsley-validate class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 form-group">
                            <input value="<?= set_value('nama_supplier', $supplier['nama_supplier']); ?>" name="nama_supplier" id="nama_supplier" type="text" class="form-control has-feedback-left" placeholder="Nama Supplier...">
                    ...
                    <div data-parsley-validate class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 form-group">
                            <input value="<?= set_value('no_telp', $supplier['no_telp']); ?>" name="no_telp" id="no_telp" type="text" class="form-control has-feedback-left" placeholder="Nomor Telepon...">
                    ...
                    <div data-parsley-validate class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 form-group">
                            <textarea name="alamat" id="alamat" class="form-control has-feedback-left" rows="4" placeholder="Alamat Supplier..."><?= set_value('alamat', $supplier['alamat']); ?></textarea>
