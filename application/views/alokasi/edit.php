        ...
        <div class="col-md-12 col-sm-12 ">
            <div class="x_panel">
                ...
                <div class="x_content">
                    <br />
                    <?= $this->session->flashdata('pesan'); ?>
                    <?= form_open('', [], ['id_alokasi' => $alokasi['id_alokasi']]); ?>

                    <div data-parsley-validate class="item form-group">
                        <label class="col-form-label col-md-3 col-sm-3 label-align" for="id_alokasi">ID Alokasi
                        </label>
                        <div class="col-md-6 col-sm-6 form-group">
                            <input readonly value="<?= set_value('id_alokasi', $alokasi['id_alokasi']); ?>" name="id_alokasi" id="id_alokasi" type="text" class="form-control has-feedback-left" placeholder="ID Alokasi...">
                    ...
                    <div data-parsley-validate class="item form-group">
                        <label class="col-form-label col-md-3 col-sm-3 label-align" for="dep">Nama Alokasi <span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 form-group">
                            <input value="<?= set_value('dep', $alokasi['dep']); ?>" name="dep" id="dep" type="text" class="form-control has-feedback-left" placeholder="Nama Alokasi...">
